{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-230c4304-1b5c-45d7-9b5e-9a38aa0a2252" = [ ];
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,4,7,20,24,18.695";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."230c4304-1b5c-45d7-9b5e-9a38aa0a2252" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "230c4304-1b5c-45d7-9b5e-9a38aa0a2252";
      ...
      "kwinrc"."Desktops"."Id_1" = "d3a90e73-1068-45fe-a59e-1e3f3021526d";
      ...
      "kwinrc"."Tiling/57c4ad3e-36a6-52e0-aeed-912c6932c5de"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/fca76cf4-c3f1-5a6c-8f6c-26bc81349f52"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Xwayland"."Scale" = 1;
      "plasma-localerc"."Formats"."LANG" = "en_US.UTF-8";
      "plasmarc"."Wallpapers"."usersWallpapers" = "/home/cypher/Phoenix/assets/wallpapers/autumnal-peach.png";
